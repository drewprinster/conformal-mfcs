...
import calibrate_20240128_FIXED as cal
import datetime
...
#     lmbdas = [2]                 # lambda, inverse temperature [0, 2, 4, 6]
    ...
    ## Drew added here
#     n_steps = 3
#     weight_adj_depth_max=2
#     fitness_str = dataset = 'red'
#     muh = 'ridge'
#     n_train_initial=15
    ...
    for l, lmbda in enumerate(lmbdas):
        ...
        for seed in range(seed_initial,seed_initial+ n_seed):
            ...
            for step in range(1,n_steps+1):
                ...
                mfset, _ = mfcs.get_confidence_set(Xtrain_nxp, ytrain_n, Xtest_1xp, lmbda, alpha=alpha, n_step_curr=weight_adj_depth)
